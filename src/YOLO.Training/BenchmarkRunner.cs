...
/// <summary>
/// Trains multiple YOLOv variants sequentially and compares their results.
/// </summary>
public class BenchmarkRunner
{
    ...
    {
        Console.WriteLine("=== YOLOv Multi-Variant Benchmark ===");
        Console.WriteLine($"Variants: {string.Join(", ", variants.Select(v => $"YOLOv{v}"))}");
        ...
        for (int i = 0; i < variants.Length; i++)
        {
            ...
            Console.WriteLine($"  [{i + 1}/{variants.Length}] Training YOLOv{variant}");
            Console.WriteLine(new string('=', 72));
            Console.WriteLine();
    ...
    private static void PrintComparisonTable(List<TrainResult> results)
    {
        ...
        foreach (var r in results)
        {
            ...
            Console.WriteLine($"YOLOv{r.ModelVariant,-4} {r.ParamCount,12:N0} " +
        ...
        {
            Console.WriteLine();
            Console.WriteLine($"  Best variant: YOLOv{bestResult.ModelVariant} " +
            ...
            {
                Console.WriteLine();
                Console.WriteLine($"  Per-Class AP@0.5 for best variant (YOLOv{bestResult.ModelVariant}):");
