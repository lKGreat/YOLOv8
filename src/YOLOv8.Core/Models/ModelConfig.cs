...
/// <summary>
/// YOLOv8 model scaling configuration.
...
/// <summary>
/// YOLOv8 model configuration with variant scaling.
/// </summary>
public static class ModelConfig
{
    /// <summary>
    /// Pre-defined model scales matching ultralytics yolov8.yaml.
    /// </summary>
    ...
    /// <summary>
    /// Base channel configuration from yolov8.yaml (before scaling).
    /// </summary>
    public static readonly long[] BackboneChannels = [64, 128, 256, 512, 1024];

    /// <summary>
    /// Base C2f repeat counts from yolov8.yaml (before depth scaling).
