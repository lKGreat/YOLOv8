...
/// <summary>
/// Loads weights from Python PyTorch checkpoint files into C# TorchSharp YOLOv8 models.
///
...
{
    /// <summary>
    /// Layer index to C# field name mapping for YOLOv8 architecture.
    ...
    /// <summary>
    /// Load weights from a Python PyTorch checkpoint file into a YOLOv8 model.
    /// Automatically handles key name remapping between Python and C# conventions.
    /// </summary>
    /// <param name="model">The target YOLOv8 model to load weights into</param>
    ...
    /// </returns>
    public static LoadResult LoadFromCheckpoint(YOLOv8Model model, string checkpointPath, bool strict = false)
    {
    ...
    /// <summary>
    /// Save a YOLOv8 model in TorchSharp native format.
    /// The saved file can be loaded directly with model.load().
    /// </summary>
    public static void SaveTorchSharp(YOLOv8Model model, string path)
    {
        model.save(path);
    ...
    /// <summary>
    /// Load a YOLOv8 model from TorchSharp native format.
    /// </summary>
    public static void LoadTorchSharp(YOLOv8Model model, string path)
    {
        model.load(path);
    ...
    /// </summary>
    public static LoadResult SmartLoad(YOLOv8Model model, string path, bool strict = false)
    {
