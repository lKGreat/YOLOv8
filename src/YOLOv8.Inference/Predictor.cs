...
using YOLOv8.Inference.PostProcess;
using static TorchSharp.torch;

namespace YOLOv8.Inference;
...
public class Predictor : IDisposable
{
    ...
    /// </summary>
    public Predictor(YOLOv8Model model, int imgSize = 640,
